...
namespace Kingo.DBUtility
{
    ...
    public abstract class OracleHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = Service.Common.ConfigurationManager.ManageConfig.instance.GetConnectionStrings("DBConnection");
        ...
        public static int ExecuteNonQueryByBuffer(string connectionString, string cmdText,  byte[] buffer)
        {
            OracleParameter[] commandParameters = new OracleParameter[1];
            commandParameters[0] = new OracleParameter(":document", OracleType.Blob);
            commandParameters[0].Value = buffer;
            OracleCommand cmd = new OracleCommand();
            OracleConnection connection = new OracleConnection(connectionString);
            PrepareCommand(cmd, connection, null, CommandType.Text, cmdText, commandParameters);
            int val = cmd.ExecuteNonQuery();
        ...
        public static DataTable ExecuteDataTable(string commandText, string connectionString)
        {
