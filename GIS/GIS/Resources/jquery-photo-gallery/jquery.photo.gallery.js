    ...
    $.fn.extend({
        ...
        photoGallery: function (options) {
            ...
            var defaults = {
                ...
                //HTML模版
                template: {
                    //操作工具'<span class="oper_download" title="下载图片"><i class="icon_tool-download"></i></span>' +
            ...
            //鼠标划入上一张区域 显示图标
            $(".prevPhoto").on("mouseover", function (e) {
                if (o.activeIndex > 0)
            ...
            //鼠标划入下一张区域 显示图标
            $(".nextPhoto").on("mouseover", function (e) {
                if (o.activeIndex < o.imgs.length - 1) {
                ...
                $(o.imgs).each(function (i, img) {
                    $(o.template.IMAGE)
                        ...
                        .css({
                            ...
                            var shade = _parent.document.getElementById("shade");
                            $(_jg).remove();
                            $(shade).remove();
                        });;
                });
            ...
            function toggleImage() {
                imageWidth = o.imgs[o.activeIndex].imgWidth > document.body.clientWidth ? document.body.clientWidth - document.body.clientWidth * 0.2 : o.imgs[o.activeIndex].imgWidth;
                imageHeight = o.imgs[o.activeIndex].imgHeight > document.body.clientHeight ? document.body.clientHeight - document.body.clientHeight * 0.1 : o.imgs[o.activeIndex].imgHeight;
    ...
    $.extend({
        ...
        openPhotoGallery: function (obj) {
            ...
            var img = $img[0],
                ...
                maxHeight = parent.document.body.clientWidth * 0.6 - windowMargin * 2,
                maxWidth = parent.document.body.clientHeight * 0.8 - windowMargin;
            ...
            var $gallerys = $(obj).closest(".tree_divright"),
                activeIndex = 0,
                imgs = [];
            ...
            if ($("#J_pg", parent.document)) {
                $("#J_pg", parent.document).remove();
            }

            //$("<iframe></iframe>").appendTo("body", parent.document)			.attr("id", "J_pg")
            //更改为父级弹窗 添加遮罩
            $("body", parent.document).append("<div id='shade'></div>");
            $("#shade", parent.document).css({
                top: 0,
                left: 0,
                width: "100%",
                height: "100%",
            ...
            $("body", parent.document).append("<iframe id='J_pg'></iframe>");
            //winWidth + 100 
            $("#J_pg", parent.document)
                .attr("src", "../../Resources/jquery-photo-gallery/gallery.html")
                .css({
                    position: "absolute",
                    left: (parent.document.body.clientWidth*0.4) / 2,
                    top: (parent.document.body.clientHeight*0.2) / 2,
                    width: parent.document.body.clientWidth * 0.6,
